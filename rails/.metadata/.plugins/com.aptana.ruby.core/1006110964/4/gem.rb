module Gem
  ...
  LOADED_SPECS_MUTEX = #<Mutex:0x007f9e4c855a10>
  ...
  RUBYGEMS_DIR = "/usr/local/Cellar/ruby/2.2.3/lib/ruby/2.2.0"
  ...
  RubyGemsPackageVersion = "2.4.5.1"
  RubyGemsVersion = "2.4.5.1"
  ...
  def self.old_default_bindir
  end

  def self.old_default_dir
  end

  def self.old_default_path
  end
